...
type CommentServiceClient interface {
	...
	AdminListComments(ctx context.Context, in *AdminListCommentsRequest, opts ...grpc.CallOption) (*AdminListCommentsResponse, error)
...
func (c *commentServiceClient) AdminListComments(ctx context.Context, in *AdminListCommentsRequest, opts ...grpc.CallOption) (*AdminListCommentsResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
	out := new(AdminListCommentsResponse)
	err := c.cc.Invoke(ctx, CommentService_AdminListComments_FullMethodName, in, out, cOpts...)
	if err != nil {
		return nil, err
	}
	return out, nil
...
func (c *commentServiceClient) AdminDeleteComment(ctx context.Context, in *AdminDeleteCommentRequest, opts ...grpc.CallOption) (*AdminDeleteCommentResponse, error) {
	cOpts := append([]grpc.CallOption{grpc.StaticMethod()}, opts...)
...
type CommentServiceServer interface {
	...
	// ===================== 后台管理（仅管理员，requireGRPCAdmin） =====================
	AdminListComments(context.Context, *AdminListCommentsRequest) (*AdminListCommentsResponse, error)
...
func (UnimplementedCommentServiceServer) AdminListComments(context.Context, *AdminListCommentsRequest) (*AdminListCommentsResponse, error) {
	return nil, status.Error(codes.Unimplemented, "method AdminListComments not implemented")
}
func (UnimplementedCommentServiceServer) AdminDeleteComment(context.Context, *AdminDeleteCommentRequest) (*AdminDeleteCommentResponse, error) {
...
func _CommentService_AdminListComments_Handler(srv interface{}, ctx context.Context, dec func(interface{}) error, interceptor grpc.UnaryServerInterceptor) (interface{}, error) {
	in := new(AdminListCommentsRequest)
	if err := dec(in); err != nil {
		return nil, err
	}
	if interceptor == nil {
		return srv.(CommentServiceServer).AdminListComments(ctx, in)
	}
	info := &grpc.UnaryServerInfo{
		Server:     srv,
		FullMethod: CommentService_AdminListComments_FullMethodName,
	}
	handler := func(ctx context.Context, req interface{}) (interface{}, error) {
		return srv.(CommentServiceServer).AdminListComments(ctx, req.(*AdminListCommentsRequest))
	}
	return interceptor(ctx, in, info, handler)
}
...
var CommentService_ServiceDesc = grpc.ServiceDesc{
	...
	Methods: []grpc.MethodDesc{
		...
		},
		{
			...
			Handler:    _CommentService_AdminListComments_Handler,
		},
		{
