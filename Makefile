...
# 与 docker-compose.yml 的宿主机映射保持一致：HTTP 8083 + gRPC 9103。
# Metrics 9093 不对外映射，由 Prometheus 在 shared-infra 网络内直接抓取。
PORTS=8083:8083 9103:9103
